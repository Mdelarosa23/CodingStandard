...
6. [Android Kotlin](#android-kotlin)
...
class ClassName {
  ...
  someFunction(name, level, status, otherData) {
    // Code here
...
- #### Naming
  ...
  Constant names use UPPER*SNAKE_CASE: all uppercase letters, with words separated by underscores. But what \_is* a constant, exactly?
